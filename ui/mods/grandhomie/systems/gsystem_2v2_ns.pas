{
    "name": "GSystem 2v2 NS",
    "description":"GSystem modified for 2v2 unshared.  Play on a medium sized planet that is micro heavy. A map that separates the very best player from the slightly less skilled. The players spawn on the poles, so fighting over metal is a must.",
    "version":"1.0",
    "creator":"AndreasG",
    "players":[4, 4],
    "planets": [
        {
            ...
            "position_x": 11000,
            "position_y": -6200,
            "velocity_x": 97.70767974853516,
            "velocity_y": 173.35235595703125,
